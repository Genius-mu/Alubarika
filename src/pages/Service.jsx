...
const Services = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="min-h-[60vh] pt-32 pb-20 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div
                key={index}
                className="group relative bg-gradient-to-br from-[#1a1f2e] via-[#0f1420] to-[#090b14] p-8 rounded-2xl border border-white/10 hover:border-green-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/10 hover:-translate-y-2"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-green-500/0 to-green-500/0 group-hover:from-green-500/5 group-hover:to-green-500/5 rounded-2xl transition-all duration-500"></div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <div className="text-3xl font-bold bg-gradient-to-b from-green-500 to-green-900 bg-clip-text text-transparent">
                  {stat.value}
                </div>
