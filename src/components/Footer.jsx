        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[15px] text-white/70 leading-relaxed">
              ...
              institutional-level trading infrastructure.
            </p>
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={i}
                  href={social.href}
                  className="w-10 h-10 bg-white/5 hover:bg-green-500/20 border border-white/10 hover:border-green-500/50 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 group"
                >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link}>
                  <a
                    href="#"
                    className="text-[15px] text-white/70 hover:text-green-400 transition-colors duration-300 hover:translate-x-1 inline-block"
                  >
                    {link}
                  </a>
                </li>
          ...
          {/* Trading */}
          <div>
            <h4 className="text-lg font-bold text-white mb-6">Trading</h4>
            <ul className="space-y-3">
              {[
                "Forex Trading",
                "Crypto Trading",
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 bg-[#0a0e1a] rounded-xl border border-white/10 focus:outline-none focus:border-green-500/50 transition-all duration-300 text-white placeholder-gray-500 text-sm"
              />
              <button className="bg-gradient-to-r from-green-600 to-green-900 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-green-600/50 transition-all duration-300 hover:scale-105 whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-6">
              {[
                ...
                <a
                  key={link}
                  href="#"
                  className="text-sm text-white/60 hover:text-green-400 transition-colors duration-300"
                >
                  {link}
                </a>
              ))}
